...
public:
     ...
     * @return algorithms
     */
    std::vector<NLOptWrAlgorithm> getAlgorithm(const NLOptWrSearchAlgoParam3& p4pAlg) const;
     ...
     * @return flag (true if a prefered algorithm is deleted)
     */
    void setPreferedAlgorithm ( nlopt::algorithm algx, int xDimMin=-1, int xDimMax=-1 );
...
protected:
     ...
     */
    bool findSearchAlgorithmR ( const NLOptWrSearchAlgoParam& p4pAlg1, std::size_t xDim, std::vector<NLOptWrAlgorithm>& res ) const;
     ...
     * @return success of search
     */
    bool findSearchAlgorithmAugLag ( const NLOptWrSearchAlgoParam& p4pAlg1, std::size_t xDim, std::vector<NLOptWrAlgorithm>& res ) const;
     ...
     * @return success of search
     */
    bool findSearchAlgorithmMlsl ( const NLOptWrSearchAlgoParam& p4pAlg1, std::size_t xDim, bool hasConstraints, std::vector<NLOptWrAlgorithm>& res) const;
     ...
     * @return success of search
     */
    bool findSearchAlgorithmLG (const NLOptWrSearchAlgoParam& p4pAlg1, std::size_t xDim, bool hasConstraints, std::vector<NLOptWrAlgorithm>& res) const;
     ...
     */
    // bool findSearchAlgorithm(const P4PrefAlgorithm& p4pAlg1, std::size_t xDim, bool ignoreConstraints, bool searchLocalOrGlobal, std::vector<NlOptAlgorithm>& res) const;
     ...
     * @return success (true means OK)
     */
    bool findSearchAlgorithm ( const NLOptWrSearchAlgoParam& p4pAlg, std::size_t xDim, bool ignoreConstraints, bool searchLocalOrGlobal, bool isNotMLSL, std::vector<NLOptWrAlgorithm>& res ) const;
...
private:
    ...
    ///
    std::vector<NLOptWrAlgorithm> getAvailableAlgorithms ( const NLOptWrSearchAlgoParam& p4pAlg,  const std::vector<class NLOptWrAlgorithm>& availableAlgs, std::size_t xDim, bool ignoreConstraints, bool searchLocalOrGlobal, bool isNotMLSL ) const;
