    ...
    for (int is = 0; is < searchStrats.size() && !foundR; is++) {
      ...
      for (size_t uAuglInt = 0; uAuglInt < 2; uAuglInt++) {
        ...
        for (size_t cgs = 0; cgs < 4 && !foundR; cgs++) {
          ...
          hasConstr = ((cgs & 2) != 0);
          // uAugl= ( ( cgs&4 ) !=0 );
          // needsSubopt= ( static_cast<int> ( searchStrats[is] ) < 0 ) || ( (
          // cgs&4 ) !=0 );
...
int selAlgTestCmp(
    ...
    const std::vector<std::tuple<nloptwr::NLOptWrSearchAlgoParam3,
                                 vector<nlopt::algorithm>>> &test0) {
  int rc = 0;

  bool rcTmp = true;
  for (size_t i = 0; i < test0.size(); i++) {
    const std::tuple<nloptwr::NLOptWrSearchAlgoParam3, vector<nlopt::algorithm>>
        &ttuple = test0.at(i);
...
/*
          ...
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::GM, false, true,
                                            false, 15),
           {nlopt::GD_MLSL, nlopt::LD_LBFGS}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::GM, true, false,
                                            false, 15),
           {nlopt::AUGLAG, nlopt::GN_DIRECT}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::GM, true, true,
                                            false, 15),
          ...
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::GM, true, true,
                                            true, 15),
           {nlopt::AUGLAG, nlopt::GD_STOGO}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::LM, false, false,
                                            false, 15),
           {nlopt::LN_COBYLA}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::LM, false, true,
                                            false, 15),
           {nlopt::LD_LBFGS}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::LM, true, false,
                                            false, 15),
           {nlopt::LN_AUGLAG, nlopt::LN_COBYLA}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::LM, true, true,
                                            false, 15),
          ...
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::LM, true, true,
                                            true, 15),
           {nlopt::LD_AUGLAG, nlopt::LD_LBFGS}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::L, false, false,
                                            false, 15),
           {nlopt::LN_COBYLA}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::L, false, true,
                                            false, 15),
           {nlopt::LD_LBFGS}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::L, true, false,
                                            false, 15),
           {nlopt::LN_COBYLA}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::L, true, true,
                                            false, 15),
           {nlopt::LD_MMA}},
          {nloptwr::NLOptWrSearchAlgoParam3(nloptwr::SSTRAT::L, false, false,
                                            true, 15),
